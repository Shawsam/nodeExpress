...
// hhAlbum.web.1.0.0（闪店定制版）
// 作者 : 立树
// 日期 : 2016-09-07
// 来源 : hhtools.web.js
// 文档 : http://studio.houheaven.com

// 依赖 : layer.js、laypage.js、Ajax.web.1.0.5.js(+)、qn.web.1.1.4.js(+)

album_config = {};
album_config.cate_url = "/system/file/api/categoryList";	// 相册分类请求地址
album_config.imgs_url = "/system/file/api/list";			// 相册图片列表请求地址
album_config.upload_url = "/system/file/api/upfile";		// 相册图片上传请求地址
...
$(function(){
    ...
    html += '    <ul>';
    html += '    <!--';
    html += '    <li data-id="35" data-src="/static/vendor/img/a1.jpg" class="selected">';
    html += '      <div>';
    html += '      <img class="lazy" src="/static/v2/img/lazy_200x200.jpg" data-src="/static/v2/img/lazy_200x200.jpg" /><b></b>';
    html += '      </div>';
    html += '      <p>图片名称.jpg</p>';
    html += '    </li>';
    html += '    -->';
    ...
    tpl2 += '      <div>';
    tpl2 += '        <img class="lazy" src2="/static/v2/img/lazy_200x200.jpg" src="{{d[i].URL}}?imageView2/1/w/200/h/200" /><b></b>';
	...
	layer.open({
		...
		success:function(layelm,idx){
			...
			foot_elm.on("click",".hh_btn",function(){
				...
				imgs_arr = [];
				for(item in imgs_obj)
				{
					imgs_arr.push(imgs_obj[item]);
				}
				Console(imgs_arr);
				Console(imgs_obj);
