...
qn_config = {
	qiniu_url:'http://7xnv4q.com1.z0.glb.clouddn.com/',
	token_url:'../pub/qn_phpsdk/uptoken.php?bukect=temp',
	flash_url:'../pub/qn_jssdk/plupload/Moxie.swf'}

var _$=["\u672a\u6307\u5b9a\u4e0a\u4f20\u6807\u7b7e\uff01","\x6d\x62","","","","\x75\x70\x6c\x6f\x61\x64\x69\x6d\x67\x77\x72\x61\x70\x5f","\x70\x69\x63\x6b\x66\x69\x6c\x65\x73\x5f","\x3c\x64\x69\x76\x20\x69\x64\x3d\x27","\x27\x3e\x3c\x2f\x64\x69\x76\x3e",'\x68\x74\x6d\x6c\x35\x2c\x66\x6c\x61\x73\x68\x2c\x68\x74\x6d\x6c\x34','\x34\x6d\x62',"\x43\x68\x6f\x6f\x73\x65\x20\x66\x69\x6c\x65\x73","\x6a\x70\x67\x2c\x6a\x70\x65\x67\x2c\x67\x69\x66\x2c\x70\x6e\x67\x2c\x62\x6d\x70","\u4e0a\u4f20\u8fdb\u5ea6\uff1a","\x3f\x69\x6d\x61\x67\x65\x56\x69\x65\x77\x32\x2f\x31\x2f\x77\x2f","\x2f\x68\x2f","\u4e0a\u4f20\u5b8c\u6bd5\uff1a","\u63a7\u4ef6\u4fe1\u606f\uff1a","\u9519\u8bef\u4fe1\u606f\uff1a","\u9519\u8bef\u63d0\u793a\uff1a","\u9519\u8bef\u63d0\u793a\uff1a","\x5f"];function imgupload(a){a=a||{};if(!a.elm){alert(_$[0]);return};var b=(a.max_size||0x64)+_$[1];var c=a.max_retry||0x1;var d=a.multi||false;var e=a.token||qn_config.token_url||_$[2];var f=a.qnsvr||qn_config.qiniu_url||_$[3];var g=a.flash||qn_config.flash_url||_$[4];var h=Date.now();var i=_$[5]+h;var j=_$[6]+h;$(a.elm).attr({id:j}).wrap(_$[7]+i+_$[8]);QNinit=Qiniu.uploader({runtimes:_$[9],flash_swf_url:g,domain:f,uptoken_url:e,browse_button:j,container:i,dragdrop:true,drop_element:i,max_file_size:b,max_retries:c,chunk_size:_$[10],auto_start:false,multi_selection:d,filters:{mime_types:[{title:_$[11],extensions:_$[12]}]},init:{'\x46\x69\x6c\x65\x73\x41\x64\x64\x65\x64':a.FilesAdded||function(k,l){plupload.each(l,function(m){k.start()})},'\x42\x65\x66\x6f\x72\x65\x55\x70\x6c\x6f\x61\x64':a.BeforeUpload||function(k,l){},'\x55\x70\x6c\x6f\x61\x64\x50\x72\x6f\x67\x72\x65\x73\x73':a.UploadProgress||function(k,l){Console(_$[13],l)},'\x46\x69\x6c\x65\x55\x70\x6c\x6f\x61\x64\x65\x64':function(k,l,m){var m=JSON.parse(m);var n=a.thumb_w||0x12c;var o=a.thumb_h||0xc8;var p=m.width;var q=m.height;var r=n/o;var s=p/q;switch(true){case (r<s)&&(q<o):n=q*r;o=q;break;case (p<n)&&(r>s):n=p;o=p/r;break};var t=Qiniu.getUrl(m.key)+_$[14]+n+_$[15]+o;a.FileUploaded(t);Console(_$[16],m);Console(_$[17],k)},'\x45\x72\x72\x6f\x72':function(k,l,m){Console(_$[18],l);Console(_$[19],m);alert(_$[20]+m)},'\x55\x70\x6c\x6f\x61\x64\x43\x6f\x6d\x70\x6c\x65\x74\x65':function(){},'\x4b\x65\x79':function(k,l){var m=Date.now()+_$[21]+l.name;return m}}});}