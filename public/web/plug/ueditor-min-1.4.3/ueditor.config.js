...
(function () {
     ...
     */
	var URL = '/static/plug/ueditor-min-1.4.3/';
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [
                     [
                      ...
                      'spechars','justifyleft','justifycenter','justifyright','link','unlink','horizontal','|',
                      'removeformat','formatmatch','pasteplain','|',
                      'emotion','music','insertvideo','attachment'
                     ],
                     [
                      'source','|',
