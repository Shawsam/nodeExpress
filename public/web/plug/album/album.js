...
album_config = {};
album_config.cate_url = "api/album/categoryList";	// 相册分类请求地址
album_config.imgs_url = "api/album/list";			// 相册图片列表请求地址
album_config.upload_url = "api/album/upfile";		// 相册图片上传请求地址
...
$(function(){
    ...
    html += '      <div>';
    html += '      <img class="lazy" src="/static/weixin/image/lazy_200x200.jpg" data-src="/static/vendor/img/a1.jpg" /><b></b>';
    html += '      </div>';
    html += '      <p>图片名称.jpg</p>';
    html += '    </li>';
    html += '    -->';
    ...
    tpl2 += '      <div>';
    tpl2 += '        <img class="lazy" src="/static/weixin/image/lazy_200x200.jpg" data-src="{{d[i].url}}?imageView2/1/w/200/h/200" /><b></b>';
